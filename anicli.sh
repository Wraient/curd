...
play_episode() {
    ...
    case "$player_function" in
        ...
        mpv*)
            ...
            echo "PLAY EPISODE VARIABLES START" >> logs
            echo "player_function : " $player_function >> logs
            echo "skip_flag : " $skip_flag >> logs
            echo "allanime_title : " $allanime_title >> logs
            echo "ep_no : " $ep_no >> logs
            echo "episode : " $episode >> logs
            echo "PLAY EPISODE VARIABLES END" >> logs
            # episode="https://www114.vipanicdn.net/streamhls/28da4cc6217f37bdb61dcfa3c785827f/ep.1.1709229738.1080.m3u8"
...
#     *)
        ...
        echo "anime_list : "$anime_list >> logs
